...
def plot_hist_subplots(
    ...
    plt.tight_layout()
    plt.savefig(path + title + f"/_sample_compare_hist_{var}.png")
    plt.show()
...
def plot_hist(
    ...
    plt.tight_layout()
    plt.savefig(path + title + f"/_direct_compare_hist_{var}.png")
    plt.show()
...
def comparison_mvaID(
    ...
    plt.tight_layout()
    plt.savefig(
        path + "mva_id_corr/" + data_name + f"_direct_compare_hist_{var1}_{var2}.png"
    )
    plt.show()
